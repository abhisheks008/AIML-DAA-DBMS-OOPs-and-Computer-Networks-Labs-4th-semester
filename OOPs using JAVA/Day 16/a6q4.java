...
public class q1 {
    public static void main(String args[]) {
        Bus obj=new Bus(1010,70,"Black","Abhishek",199); 
        System.out.println(obj.ShowData());
        Car obj1=new Car(1010,70,"Black","Abhishek","TATA"); 
...
/*
Output :
Bus [routeNumber=199, regnNumber=1010, speed=70, color=Black, ownerName=Abhishek]
Car [manufacturerName=TATA, regnNumber=1010, speed=70, color=Black, ownerName=Abhishek]
*/
